...
const ISSUER = new URL(String(process.env["REACT_APP_OIDC_AUTHORITY_URL"]), CLIENT_URL);
const SCOPE = new URL(String(process.env["REACT_APP_OIDC_SCOPE"]), CLIENT_URL);
const CLIENT_ID = new URL(String(process.env["REACT_APP_OIDC_CLIENT_ID"]), CLIENT_URL);
