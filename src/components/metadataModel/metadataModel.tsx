    ...
    <div className="mx-auto px-5 my-4">
      ...
      >
        ...
        <div className="overflow-auto">
          <p className="fw-bold">
            The GHGA Data Portal provides core functionality to capture metadata and allows for FAIR compliant sharing of genomics data.
            ...
            The implementation of our Data Portal is done using the Linked Data Modelling Language (LinkML) and is openly accessible for everyone on the GHGA GitHub Repository.
