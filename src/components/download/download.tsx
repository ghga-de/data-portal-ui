        ...
        <div className="mx-auto px-5 my-4">
            ...
            >
                ...
                <div className="overflow-auto">
                    <p className="fw-bold">
                        ...
                        Currently we are running an early phase project called GHGA Data Portal, listing anonymous metadata and
            ...
            <div>
                ...
                <p className="mb-5">
                    ...
                    <strong>Note: The GHGA Data Portal is not resposible for data accesion</strong>
                </p>
            </div>
            <div>
