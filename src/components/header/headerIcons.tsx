...
const HeaderIcons = () => {
  return (
    <Nav className="d-inline-block mb-3 mt-2 mx-lg-3">
      <Navbar.Brand href="https://twitter.com/GHGA_DE">
        <Twitter color="grey" size={25} />
      </Navbar.Brand>
      <Navbar.Brand href="https://github.com/ghga-de">
        <Github color="grey" size={25} />
      </Navbar.Brand>
      <Navbar.Brand href="https://www.youtube.com/channel/UC7Yqi4gBl86drcUxwwEe6EA">
