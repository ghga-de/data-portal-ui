...
const Filter = (props: filterProps) => {
  ...
  return (
    <Container className="col-11 mb-3 fs-7 mx-0 w-100 p-0">
      <Form>
        <Form.Label className="mt-0 mb-3 text-capitalize fs-5"><strong>{props.facet.name}</strong></Form.Label>
                ...
                <div className="p-1 d-flex align-top mb-1" key={key}>
                  ...
                  <Form.Label className="p-0 m-0 w-100" htmlFor={key}  style={{cursor: "pointer"}}>
                    <Row>
                      ...
                      <Col lg={2} md={2} sm={2} xl={2} xs={2} xxl={2} className="h-100 ps-0 pe-3">
                        <Form.Label className="p-0 m-0 w-100" htmlFor={key}>
                          <Badge className="w-100 user-select-none px-0"  style={{cursor: "pointer"}}>{option.count}</Badge>
                        </Form.Label>
                      </Col>
                    </Row>
                  </Form.Label>
