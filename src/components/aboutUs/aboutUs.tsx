    ...
    <div className="mx-auto px-5 mt-4">
      ...
      >
        <Col className="fw-bold text-white col-11">
          ...
          ></div>
          <p className="ps-3 mb-3">
            1) Provide the first public-facing service (“the GHGA Data Portal”) to make human omics datasets from Germany findable to researchers, <br />
            ...
            In the next phase of GHGA, entitled GHGA Archive, GHGA will archive personal research data on behalf of the data controllers and will make those data findable via the GHGA Data Portal.
          </p>
        </Col>
      </Row>
      <Row className="m-0 ps-4">
        <Col>
          ...
          <Row className="mb-4">
            <p className="fw-bold">What are the functions of the GHGA Data Portal?</p>
            <p>
              The GHGA Data Portal allows users to browse, search, and filter omics datasets submitted to the GHGA. It uses the GHGA Metadata Model and conforms with the&nbsp;
          ...
          <Row className="mb-4">
            <p className="fw-bold">What data can be found on GHGA Data Portal?</p>
            <p>
          ...
          <Row className="mb-4">
            ...
            <p>
              Identify your dataset of interest using the browse and filter functions of the GHGA Data Portal.
          ...
          <Row className="mb-4">
            <p className="fw-bold">How to upload your data to GHGA Data Portal?</p>
            <p>
          ...
          <Row>
            ...
            <p>
              ...
              During this early phase of the project, called GHGA Data Portal, we are listing non-personal metadata and acting as a gateway to data submitters who will serve the research data upon approval of the request.
          ...
          <Row>
            ...
            <p>
              ...
              During this early phase of the project, called GHGA Data Portal, metadata on datasets is only collected from our partner institutions.
              If you are located at a GHGA partner institute and would like to upload your metadata to GHGA Data Portal, please contact the GHGA Helpdesk at ghga-office@dkfz-heidelberg.de
            </p>
            <p>
