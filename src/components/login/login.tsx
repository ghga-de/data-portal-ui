      ...
      <div className="w-75 my-5 pb-5">
        <div className="bg-light p-4 my-5 rounded text-center mb-5 pb-5">
          <p className="mb-4">
            ...
            log in via <strong>LS Login</strong>.
          </p>
          <p className="mb-4">
            LS Login lets you authenticate using your existing accounts at third
            parties (your home university, research institute or a commercial
            service) and link it to your LS ID. Alternatively, you can also
            activate an LS account with username and password.
          </p>
          <img
            src={lsLogin}
            alt="LS Login"
        ...
        <div className="bg-light-alternative p-4 my-5 rounded text-center mb-5 pb-5">
          <p className="mb-4">
            If you have never used <strong>LS Login</strong> before, you can
            register here.
          </p>
