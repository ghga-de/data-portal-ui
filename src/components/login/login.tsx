...
const Login = () => {
  return (
    <Container className="px-5 d-flex justify-content-center">
      <div className="w-75">
      <div className="bg-light-alternative p-4 my-5 rounded text-center">
        <p className="mb-4">
          To upload/download data to the{" "}
          <strong>German Human Genome-Phenome Archive</strong>, you need to sign
          in via a <strong>Life Science</strong> account.
        </p>
      ...
      <div className="bg-light-alternative p-4 my-5 rounded text-center">
        ...
        <a href="https://signup.aai.lifescience-ri.eu/fed/registrar/?vo=lifescience">
